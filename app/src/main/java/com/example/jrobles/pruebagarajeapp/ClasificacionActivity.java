...
public class ClasificacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab = actionBar2.newTab().setText("Thai").setTabListener(tabListener);
        actionBar2.addTab(tab);

        tab = actionBar2.newTab().setText("Veggie").setTabListener(tabListener);
        actionBar2.addTab(tab);

        tab = actionBar2.newTab().setText("Verona").setTabListener(tabListener);
        actionBar2.addTab(tab);
        ...
        //----------------------------------Ajuste del menu--------------------------------
        drawerLayout = (DrawerLayout) findViewById(R.id.contenedorPrincipalClasificacion);

        listView = (ListView) findViewById(R.id.menuIzqClasificacion);
